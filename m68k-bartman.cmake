...
if(WIN32)
    if(DEFINED VSCODE_AMIGA_EXTENSION_PATH)
        set(TOOLCHAIN_PATH_DEFAULT ${VSCODE_AMIGA_EXTENSION_PATH}/bin/win32/opt)
    else()
        set(TOOLCHAIN_PATH_DEFAULT C:/Users/$ENV{USERNAME}/.vscode/extensions/bartmanabyss.amiga-debug-1.7.9/bin/win32/opt)
    endif()
else()
    if(DEFINED VSCODE_AMIGA_EXTENSION_PATH)
